...
$(function () {
    ...
    $.ajax({
        type: "POST",
        url: $('#CurRootFile').val() + "/ajax/quality.asp",
        data: data,
        //dataType: 'json',
        success: function (data) {
            ...
            $('#dtlist .deletelink').on('click', function () {
                ...
                $('#decisionbtn').click({id: data['qualityid']}, function (e) {
...
function populateform(data) {
    ...
    $('#streamtypeid').val(data['streamtypeid']);
    $('#complaintscnt').val(data['complaintscnt']);
    $('#lrotcnt').val(data['lrotcnt']);
...
function emptyform() {
    ...
    $('#streamtypeid').val($('#userstreamtypeid').val());
    $('#complaintscnt').val('');
    $('#lrotcnt').val('');
...
function save_data() {
    ...
    var id = $('#qualityid').val();
    var dateid = $('#dateid').val();
    var departmentid = $('#departmentid').val();
    var streamtypeid = $('#streamtypeid').val();
    var complaintscnt = $('#complaintscnt').val();
    var lrotcnt = $('#lrotcnt').val();
