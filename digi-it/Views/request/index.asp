            ...
            <div class="modal-body mx-3">
                <form id="appform">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="elognb" name="elognb" class="form-control" onkeypress="return isNumberKey(event)" minlength="6" readonly/>
                        </div>
                    </div>
                    <div class="form-group row app">
                        ...
                        <label class="switch mt-2 ml-3">
                            <input class="mt-1" type="checkbox" name="isgxp" id="isgxp" value="1">
                    ...
                    <div class="modal-footer d-flex justify-content-center">
                        ...
                        <button type="button" class="btn btn-cyan" id="btnApprove"><div id="spinner-request-approve"></div><%=GetLabel("btnApprove", Lang)%></button>
                        <button type="button" class="btn btn-grey" id="btnReject"><div id="spinner-request-reject"></div><%=GetLabel("btnReject", Lang)%></button>
                    </div>
        ...
        <div class="card">
            <div class="card-header-black">
                <div class="float-left">
                    <h5 class="ml-2 mt-2 dark-grey-text font-weight-bold"><i class="<%=cRequestInboxApproveIcon%>"></i>&nbsp;<%=GetLabel("mnuMainRequestMaintain", Lang) & "&nbsp;-&nbsp;" & GetLabel("lblRequestlist", Lang)%></h5>
                </div>
                    ...
                    <table id="dtlist" name="dtlist" class="table table-striped table-bordered table-sm table-hover row-cursor" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th style="display:none">ItemStatusID</th>
                                ...
                                <th style="display:none">ElogNb</th>
                        ...
                        <tbody>
                            <% For Each vwItem In vwList.Items  %>
                                <tr>
                                    ...
                                    <td style="display:none"><%=vwItem.ElogNb%></td>
...
<!--Section: Table-->
<!-- javascript -->
<script src="<%=curRootFile%>/_js/request/index_1_4.js?v1.5"></script>