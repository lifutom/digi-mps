        ...
        <div class="card">
            <div class="card-header-black">
                <div class="float-left">
                    <h5 class="ml-2 mt-2 dark-grey-text font-weight-bold">&nbsp;<i class="<%=cRequestTypeGrantIcon%>"></i>&nbsp;<%=GetLabel("lblRequestForm", Lang) & " - " & GetLabel("lblAccessRights", Lang)%></h5>
                </div>
            ...
            <div class="card-body">
                ...
                <form id="form" action="javascript:saveData();">
                    ...
                    <input type="hidden" id="reqtypeid" name="reqtypeid" value="<%=cRequestTypeGrant%>"/>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="detail" role="tabpanel" aria-labelledby="detail-tab">
                             <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="accesstypeid" id="accesstypeid" class="form-control search-drowdown" style="width: 15%;">
                                        <option value="" disabled selected>--&nbsp;<%=GetLabel("lblAccessItemType", Lang)%>&nbsp;--</option>
                                        <% For Each vwItem In vwAccessTypeList.Items %>
                                            <option value="<%=vwItem.Value%>"><%=vwItem.Name%></option>
                                        <% Next %>
                                    </select>
                    ...
                    <div class="modal-footer d-flex justify-content-center">
                        ...
                        <button type="submit" class="btn btn-cyan sendbtn" id="sendbtn"><div id="showspinner"></div>&nbsp;<i class="<%=cRequestTypeGrantIcon%>"></i>&nbsp;<%=GetLabel("btnSubmit", Lang)%></button>&nbsp;
...
<!--Section -->
<!-- javascript -->
<script src="<%=curRootFile%>/_js/request/accessform.js?v1.1"></script>