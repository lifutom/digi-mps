        ...
        <div class="card">
            <div class="card-header-black">
                <div class="float-left">
                    <h5 class="ml-2 mt-2 dark-grey-text font-weight-bold"><i class="<%=cRequestToDoTaskIcon%>"></i>&nbsp;<%=GetLabel("mnuMainWorkListMaint", Lang)%>&nbsp;<%=GetLabel("mnuMainRequestHistory", Lang)%></h5>
                </div>
                    ...
                    <table id="dtlist" name="dtlist" class="table table-striped table-bordered table-sm table-hover row-cursor" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th nowrap class="th-sm"><%=GetLabel("lblRequestedFor", Lang)%></th>
                            ...
                            <% For Each vwItem In vwList.Items  %>
                                <tr>
                                    ...
                                    <td nowrap>
                                        ...
                                        <% If vwItem.TaskTypeID=cTaskTypeUpload AND vwItem.TaskStateID > 30 And 1=0 Then %>
                                                <a href="<%=vwItem.DownloadUrl%>" target="_blank"><i class="<%=cTaskTypeDownloadIcon%>"></i></a>
                                        <% End If %>
                                    </td>
                                </tr>
                            <% Next %>
...
<!--Section: Table-->
<!-- javascript -->
<script src="<%=curRootFile%>/_js/worklist/history.js?v1.3"></script>