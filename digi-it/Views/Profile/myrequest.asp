        ...
        <div class="card">
            <div class="card-header-black">
                <div class="float-left">
                    <h5 class="ml-2 mt-2 dark-grey-text font-weight-bold"><i class="<%=cRequestInboxApproveIcon%>"></i>&nbsp;<%=GetLabel("mnuMainProfileMyRequest", Lang)%></h5>
                </div>
...
<!--Section: Table-->
<!-- javascript -->
<script src="<%=curRootFile%>/_js/profile/myrequest.js?v1.1"></script>