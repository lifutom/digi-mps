...
<section class="mb-5">
    ...
    <div class="card card-cascade narrower">
        ...
        <div class="view view-cascade py-3 gradient-card-header grey mx-4 d-flex justify-content-between align-items-center">
            <a href="" class="white-text text-center mx-3"><i class="fas fa-eye"></i>&nbsp;Task suchen&nbsp;(<%=DBFormatDateTime(Now)%>)</a>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-5">
                    ...
                    <div class="form-group row">
                        <label for="tasknb" class="col-sm-3 col-form-label">Task-Nr:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="tasknb" name="tasknb" value="<%=Session("tasknb")%>">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-2">
                    <button type="submit" class="btn btn-primary" id="cmdfilter" name="cmdfilter">Suchen</button>
                </div>
            </div>
            </form>
        </div>
...
<!-- javascript -->
<script src="<%=curRootFile%>/js/pages/near/taskhistory.js?v1.0"></script>
