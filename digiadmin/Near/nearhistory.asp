...
<section class="mb-5">
    ...
    <div class="card card-cascade narrower">
        ...
        <div class="view view-cascade py-3 gradient-card-header grey mx-4 d-flex justify-content-between align-items-center">
            <a href="" class="white-text text-center mx-3"><i class="fas fa-eye"></i>&nbsp;Meldungen suchen&nbsp;(<%=DBFormatDateTime(Now)%>)</a>
...
<!-- javascript -->
<script src="<%=curRootFile%>/js/pages/near/nearhistory.js?v1.1"></script>
