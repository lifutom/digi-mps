    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h4 class="modal-title w-100 font-weight-bold"><i class="fab fa-algolia"></i>&nbsp;&nbsp;Tier2: Safety Issues</h4>
            ...
            <div class="modal-body mx-3">
                <form id="editform" action="javascript:save_data();">
                    ...
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label style="font-size: 14px;" for="escastart">erstellt:</label><br>
                    ...
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label style="font-size: 14px;" for="escaclosed">abgeschlossen:</label><br>
                            <input class="mt-3" id="closed" name="closed" type="date" value="">
                        </div>
                    </div>
...
<section class="mb-5">
    ...
    <div class="card card-cascade narrower">
        ...
        <div class="view view-cascade py-3 gradient-card-header grey mx-4 d-flex justify-content-between align-items-center">
            <a href="" class="white-text text-center mx-3"><i class="fab fa-algolia"></i>&nbsp;Safety Issues Tier2</a>
...
<!-- javascript -->
<script src="<%=curRootFile%>/js/pages/tier2/safetyissues.js?v1.0"></script>
