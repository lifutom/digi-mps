                    ...
                    <div class="table-responsive">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input id="boxid" name="boxid" type="number" min="0" value="" required="required">
                                </td>
                            </tr>
                            <tr>
                                <td>
...
<div class="modal fade" id="editLink" tabindex="-1" role="dialog" aria-labelledby="EditLink" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-center">
                <div class="float-left"><img src="<%=curRootFile%>/Images/msd.png" alt="logo" title="MSD Austria" width="40" height="40"></div>
                <h4 class="modal-title w-100 font-weight-bold"><i class="fas fa-home"></i>&nbsp;&nbsp;Linienzuordnung</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                    ...
                    <div class="table-responsive">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <select id="plantid" name="plantid" class="browser-default custom-select" required>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="deviceid" name="deviceid" class="browser-default custom-select" required>
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <select id="moduleid" name="moduleid" class="browser-default custom-select">
                                        <option value="" disabled>--Auswahl einer Baugruppe--</option>
                                        <%
...
<!--Section: Main panel-->
    ...
    <input id="snb" name="snb" type="hidden" value="<%=vwItem.SpareNb%>">
 ...
 <!-- javascript -->
<script src="<%=curRootFile%>/js/pages/spare/spareedit.js?v=1.0"></script>