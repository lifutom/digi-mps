...
<section class="mb-5">
    ...
    <div class="card card-cascade narrower">
        ...
        <div class="view view-cascade py-3 gradient-card-header grey mx-4 d-flex justify-content-between align-items-center">
            <a href="" class="white-text text-center mx-3"><i class="fas fa-eye"></i>&nbsp;Meldungen&nbsp;(<%=DBFormatDateTime(Now)%>)</a>
            <div class="float-right">
                 &nbsp;&nbsp;<a class="white-text" href="<%=curRootFile%>/near" title="Refresh"><i class="fas fa-sync"></i></a>
            </div>
        </div>
        <!--/Card header-->
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table id="dtlist" class="table table-bordered table-sm table-hover row-cursor" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th></th>
                            <th style="display:none">TypID</th>
                        </tr>
                    </thead>
                    <tbody>
                    <%  Dim cssClass : cssClass = ""
                        ...
                        For Each ListItem In vwList.Items
                            ...
                            <tr>
                                ...
                                <td style="display:none"><%=ListItem.Typ%></td>
                            </tr>
                    <% Next %>
                    </tbody>
                </table>
...
<!-- javascript -->
<script src="<%=curRootFile%>/js/pages/near/index.js?v1.3"></script>
