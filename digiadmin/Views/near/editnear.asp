                ...
                <div class="col-12">
                    <form class="form" id="form" name="form" method="POST" action="<%=CurRootFile%>/near/uploadmultipost?partial=yes" enctype="multipart/form-data">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="customFileLang">Wählen Sie Dokumente/Fotos aus</label>
                        </div>
                        <div class="modal-footer d-flex justify-content-center">
                            <button type="submit" class="btn btn-cyan sendbtn" id="sendbtn">Speichern</button>
                            <button class="btn btn-danger" data-dismiss="modal">Abbrechen</button>
        ...
        <div class="card-footer">
                ...
                <div style="float: right;">
                    <% If vwItem.Queue = "ehs"  Then
                        ...
                        <button class="btn-sm btn-default" name="cmdForward" id="cmdForward" type="button" value="spv"><i class="fas fa-caret-square-right"></i>&nbsp;Zurück zu SPV</button>&nbsp;
                    <%    End If
                    Else %>
                ...
                <div class="text-center">
                    <% If vwItem.Queue = "ehs"  Then %>
                        <button class="btn-sm btn-default" name="cmdClose" id="cmdClose" type="button" value="1"><%=IIf(vwItem.State = 3, "<i class=""fas fa-lock-open""></i>&nbsp;Wieder öffnen" ,"<i class=""fas fa-lock""></i>&nbsp;Abschließen")%></button>
                    <% Else %>
                       &nbsp;&nbsp;&nbsp;&nbsp;
                    <% End If %>
                </div>
