    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h4 class="modal-title w-100 font-weight-bold"><i class="fab fa-algolia"></i>&nbsp;&nbsp;Tier1:Capa-Daten</h4>
            ...
            <div class="modal-body mx-3">
                <form id="editform" action="javascript:save_data();">
                    ...
                    <input id="capaid" name="capaid" type="hidden" value="">
                    ...
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label for="capanb">CAPA-Nr:</label>
                            CA-<input class="mt-2" id="capanb" name="capanb" type="text" maxlength="7" minlength="7" max="7" required value="" placeholder="CAPA Nummer">
                        </div>
                    </div>
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label style="font-size: 14px;" for="capastart">CAPA erstellt:</label><br>
                            <input class="mt-2" id="capastart" name="capastart" type="date" required value="">
                        </div>
                    </div>
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label for="capadescription">Kurzbeschreibung:</label>
                            <textarea class="mt-1" id="capadescription" name="capadescription" maxlength="255" rows="3" cols="40" required placeholder="CAPA Kurzbeschreibung">
                            </textarea>
                        </div>
                    </div>
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label style="font-size: 14px;" for="capaclosed">CAPA abgeschlossen:</label><br>
                            <input class="mt-3" id="capaclosed" name="capaclosed" type="date" value="">
                        </div>
                    </div>
...
<section class="mb-5">
    ...
    <div class="card card-cascade narrower">
        ...
        <div class="view view-cascade py-3 gradient-card-header grey mx-4 d-flex justify-content-between align-items-center">
            <a href="" class="white-text text-center mx-3"><i class="fab fa-algolia"></i>&nbsp;CAPA-Daten</a>
            <div class="float-right">
                 ...
                 &nbsp;&nbsp;<a class="white-text" href="<%=curRootFile%>/tier1/capa" title="Refresh"><i class="fas fa-sync"></i></a>
            </div>
        </div>
        <!--/Card header-->
...
<!-- javascript -->
<script src="<%=curRootFile%>/js/pages/tier1/capa.js?v1.1"></script>
