    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h4 class="modal-title w-100 font-weight-bold"><i class="fab fa-algolia"></i>&nbsp;&nbsp;Tier1:CC-Daten</h4>
            ...
            <div class="modal-body mx-3">
                <form id="editform" action="javascript:save_data();">
                    ...
                    <input id="ccid" name="ccid" type="hidden" value="">
                    ...
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label for="ccnb">CC-Nr:</label>
                            CC-<input class="mt-2" id="ccnb" name="ccnb" type="text" maxlength="7" minlength="7" max="7" required value="" placeholder="CC Nummer">
                        </div>
                    </div>
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label style="font-size: 14px;" for="ccstart">CC erstellt:</label><br>
                            <input class="mt-2" id="ccstart" name="ccstart" type="date" required value="">
                        </div>
                    </div>
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label for="ccdescription">Kurzbeschreibung:</label>
                            <textarea class="mt-1" id="ccdescription" name="ccdescription" maxlength="255" rows="3" cols="40" required placeholder="CC Kurzbeschreibung">
                            </textarea>
                        </div>
                    </div>
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label style="font-size: 14px;" for="ccclosed">CC abgeschlossen:</label><br>
                            <input class="mt-3" id="ccclosed" name="ccclosed" type="date" value="">
                        </div>
                    </div>
...
<section class="mb-5">
    ...
    <div class="card card-cascade narrower">
        ...
        <div class="view view-cascade py-3 gradient-card-header grey mx-4 d-flex justify-content-between align-items-center">
            <a href="" class="white-text text-center mx-3"><i class="fab fa-algolia"></i>&nbsp;CC-Daten</a>
...
<!-- javascript -->
<script src="<%=curRootFile%>/js/pages/tier1/cc.js?v1.1"></script>
