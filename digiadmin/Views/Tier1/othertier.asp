<%
   ...
   Dim vwDDOtherCats : Set  vwDDOtherCats = ViewData("ocadlist")
   Dim ListItem
%>
<style>
    textarea {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h4 class="modal-title w-100 font-weight-bold"><i class="fab fa-algolia"></i>&nbsp;&nbsp;Tier1:Waste/Cost</h4>
            ...
            <div class="modal-body mx-3">
                <form id="editform" action="javascript:save_data();">
                    ...
                    <div class="md-form mb-2">
                        <label style="font-size: 14px;" for="ocatid">Kategorie:</label><br>
                        <select id="ocatid" name="ocatid"class="browser-default custom-select mt-3" required>
                            <option value="" selected disabled>W&auml;hlen Sie die Kategorie aus</option>
                            <%

                                For Each DDItem In vwDDOtherCats.Items
                                        %><option value="<%=DDItem.Value%>"><%=DDItem.Name%></option><%
                                Next
                    ...
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label style="font-size: 14px;" for="ostart">erstellt:</label><br>
                            <input class="mt-2" id="ostart" name="ostart" type="date" required value="">
                        </div>
                    </div>
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label for="odescription">Beschreibung:</label>
                            <textarea class="mt-1" id="odescription" name="odescription" maxlength="255" rows="3" cols="40" required placeholder="Beschreibung">
                            </textarea>
                        </div>
                    </div>
                    <div class="md-form mb-2">
                        <div class="md-form">
                            <label style="font-size: 14px;" for="oclosed">abgeschlossen:</label><br>
                            <input class="mt-3" id="oclosed" name="oclosed" type="date" value="">
                        </div>
                    </div>
...
<section class="mb-5">
    ...
    <div class="card card-cascade narrower">
        ...
        <div class="view view-cascade py-3 gradient-card-header grey mx-4 d-flex justify-content-between align-items-center">
            <a href="" class="white-text text-center mx-3"><i class="fab fa-algolia"></i>&nbsp;Cost/Waste-Daten</a>
            <div class="float-right">
                 ...
                 &nbsp;&nbsp;<a class="white-text" href="<%=curRootFile%>/tier1/other" title="Refresh"><i class="fas fa-sync"></i></a>
            </div>
        </div>
        <!--/Card header-->
                ...
                <table id="dtlist" class="table table-striped table-bordered table-sm table-hover row-cursor" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="display:none">OCatID</th>
...
<!-- javascript -->
<script src="<%=curRootFile%>/js/pages/tier1/othertier.js?v1.0"></script>
