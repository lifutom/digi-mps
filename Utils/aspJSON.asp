...
Class aspJSON
        ...
        Public Function GetPaymentStatus()
            ...
            Dim oStatus
            Set oStatus = New PaymentStatus

            oStatus.TransCode = data("result").Item("code")
            oStatus.TransDescr = data("result").Item("description")

            Set GetPaymentStatus = oStatus
                        ...
                        Case Else
                                ...
                                If (Instr(val, """") = 0) Then
                                        ...
                                        If IsNumeric(val) Then
                                                ...
                                                getJSONValue = CDbl(Replace(Val,".", strDecSep))
                                        Else
                                                getJSONValue = val
                                        End If
                                Else
