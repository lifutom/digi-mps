...
Class DeliveryEsca
    ...
    Private Sub InitObject()
        ...
        Dim SQLStr : SQLStr = "SELECT * FROM vwTierDeliveryEsca WHERE escaid='" & mEscaID & "'"
    ...
    Public Function Save()
        ...
        Cmd.CommandText = "DeliveryEscaUpdate"
    ...
    Public Function Delete()
        ...
        Dim SQLStr : SQLStr = "DELETE FROM tier_delivery_esca WHERE escaid='" & mEscaID & "'"
...
Class DeliveryEscaHelper
    ...
    Public Function OpenEscaList
        ...
        Dim List : Set List = Server.CreateObject("Scripting.Dictionary")
        Dim SQLStr : SQLStr = "SELECT * FROM vwTierDeliveryEsca WHERE escaclosed IS NULL ORDER BY dateid desc"
        Dim Rs : Set Rs = DbExecute(SQLStr)
        Dim Item
    ...
    Public Function EscaListByDate(DateID)
        ...
        Dim List : Set List = Server.CreateObject("Scripting.Dictionary")
        Dim SQLStr : SQLStr = "SELECT * FROM vwTierDeliveryEsca WHERE CONVERT(date,escastart) = CONVERT(date,'" & DateID & "')"
        Dim Rs : Set Rs = DbExecute(SQLStr)
        Dim Item
