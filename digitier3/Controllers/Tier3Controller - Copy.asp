...
Class Tier3Controller
    ...
    Public Sub DeliveryPack()
        ...
        ViewData.Add "curcw", Datepart("w",DateID)
        ViewData.Add "dateid", DateID
    ...
    Public Sub QualityHour()
        ...
        ViewData.Add "qualityhour", Helper.OpenExcel (QualityHourPath,"KW " & datepart("ww",Date))
    ...
    Public Sub DeliveryCritical()
        ...
        ViewData.Add "criticalstock", Helper.OpenExcel (CriticalStockPath,"Tabelle1")
