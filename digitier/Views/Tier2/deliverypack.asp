    ...
    <div class="card card-cascade narrower">
        ...
        <div class="view view-cascade py-3 gradient-card-header grey mx-4 d-flex justify-content-between align-items-center">
            ...
            <div class="float-right">
                 <a class="white-text" href="<%=curRootFile%>/tier2/deliverypack" title="Refresh"><i class="fas fa-sync"></i></a>
            </div>
        </div>
        <!--/Card header-->
        <!--Card content-->
            ...
            <div class="row">
                <div class="col-8">
                    <% For Each vwItem In vwList.Items %>
                        <div class="plantname_<%=vwItem.PlantID%>"></div>
                        <div id="chartdiv" class="col-12">
                             <canvas id="oeechart_<%=vwItem.PlantID%>" height="100"></canvas>
                        </div>
                        <div id="chartdiv1" class="col-12">
                            <canvas id="outputchart_<%=vwItem.PlantID%>" height="100"></canvas>
                        </div>
                    <% Next %>
                </div>
                <div class="col-4">
                        ...
                        <div class="card-body card-body-cascade text-center">
                            ...
                            <table class="table table-striped table-bordered table-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <%=vwOverView.OEEValueText%>
                                            </td>
                                            <td>
                                                <%=vwOverView.OEEValueAvgText%>
                                            </td>
                                        </tr>
                                    </tbody>
                            </table>
                            ...
                            <table class="table table-striped table-bordered table-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <%=vwOverView.OutputCntText%>
                                            </td>
                                            <td>
                                                <%=vwOverView.PlannedOutputCntText%>
                                            </td>
                                        </tr>
                                    </tbody>
                            </table>
...
<!-- javascript -->
<script src="<%=curRootFile%>/_js/tier2/deliverypack.js?v.1.1"></script>