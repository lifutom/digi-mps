...
-- Coaches Data
INSERT INTO menu (menuid, menuname, menulink, iconclass, hassubmenus, active, mainsort, subsort)
VALUES ('tier1','Tier Daten','#','fab fa-algolia', 1, 1, 20, 0)
INSERT INTO menu (menuid, menuname, menulink, iconclass, hassubmenus, active, mainsort, subsort)
...
INSERT INTO menu (menuid, menuname, menulink, iconclass, hassubmenus, active, mainsort, subsort)
VALUES ('tier1_othernote','WorkItem','/tier1/othernote','fab fa-algolia', 0, 1, 20, 9)
INSERT INTO menu (menuid, menuname, menulink, iconclass, hassubmenus, active, mainsort, subsort)
VALUES ('tier1_other','Waste/Cost','/tier1/other','fab fa-algolia', 0, 1, 20, 10)
INSERT INTO menu (menuid, menuname, menulink, iconclass, hassubmenus, active, mainsort, subsort)
VALUES ('tier1_delivery_pack','Delivery Packaging','/tier1/deliverypack','fab fa-algolia', 0, 1, 20, 11)
INSERT INTO menu (menuid, menuname, menulink, iconclass, hassubmenus, active, mainsort, subsort)
VALUES ('tier1_delivery_prod','Delivery Bulk','/tier1/deliverybulk','fab fa-algolia', 0, 1, 20, 12)
--INSERT INTO menu (menuid, menuname, menulink, iconclass, hassubmenus, active, mainsort, subsort)
